...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        ...
        '/store/data/Run2016F/SingleMuon/RAW/v1/000/278/018/00000/A058A03A-A058-E611-8713-02163E011935.root',#events 1540061587, 1539957230, 1539578840
    ...
    eventsToProcess = cms.untracked.VEventRange(
        ...
        ##########################
        #missing emu track events#
        ##########################

        #'278018:1686648178',#fixed: Neighbor and normal hit were from same chamber Id and so thetas were swapped errantly. Added neighbor restriction to solve
        #'278018:1540061587',#Simulator gives a new theta other than what I calculate and so doesn't fail dth req. Need to ask. Wire doesn't change with two hits
        #'278018:1539957230'#fixed: Applying shared segment cancellation on hits 'removed' in deltas module
        #'278018:1539578840',#simulator gives a new theta that what I calculate. Need to ask
        #'278018:1541093157',#alex matches station 4 though it is out of zone by both our definitions I think. Need to ask.
        ...
        #'278018:1687477843',#bx issue. Would have found if readout window was longer
        '278018:1687724238',
    ),
...
process.step1 = cms.Path(process.muonCSCDigis+process.muonRPCDigis+process.castorDigis+process.scalersRawToDigi+process.tcdsDigis+process.csctfDigis+process.gtDigis+process.simCscTriggerPrimitiveDigis+process.emtfStage2Digis+process.simEmtfDigis)
#2nd in above +process.muonDTDigis
#after csctfDigis +process.gtDigis
